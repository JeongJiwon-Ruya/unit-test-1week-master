...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, anyOf(startsWith("Player"),endsWith("Focus"), containsString("in")));
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames, hasToString("[루시안, 애쉬, 렉사이, 갈리오, 모르가나, 블라디미르]"));
    }
    ...
    public void shouldTopChampionIsDarius() {
        Optional<Champion> filteredChamion = championList.stream().filter(c -> c.getPosition().equals("탑")).findFirst();

        assertThat(filteredChamion.get().getName(), is("다리우스"));
        assertTrue(filteredChamion.get().getPosition().equals("탑"));
        System.out.println("champ :: " + filteredChamion);
    }
